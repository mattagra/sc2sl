  ...
  def create
    ...
    respond_to do |format|
      if @moderation.save
        ...
        when "warned"
          UserMailer.delay.warning(@moderation.user, @moderation)
        when "banned"
          UserMailer.delay.ban(@moderation.user, @moderation)
        when "permabanned"
          UserMailer.delay.permaban(@moderation.user, @moderation)
        end
